...
/**
 * A Datastore Transaction. This interface extends the {@link DatastoreAccess}. DatastoreTransaction
 * objects are created with a call to {@link EntityManager#newTransaction()}. Once a handle to
 * {@link DatastoreTransaction} is obtained, it can be used to perform various database operations
