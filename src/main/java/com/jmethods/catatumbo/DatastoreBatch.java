...
/**
 * Interface for executing Batch updates (Insert/Update/Delete). Instances of this class are
 * obtained by calling {@link EntityManager#newBatch()}.
 *
...
public interface DatastoreBatch {
  ...
  /**
   * Tells whether or not this DatastoreBatch is still active. A DatastoreBatch is considered active
   * if it is not submitted yet.
   *
   * @return <code>true</code>, if this batch is active; <code>false</code>, otherwise.
   */
  boolean isActive();
