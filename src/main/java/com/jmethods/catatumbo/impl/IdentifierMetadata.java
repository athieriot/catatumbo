...
public class IdentifierMetadata extends FieldMetadata {
	 ...
	 */
	public IdentifierMetadata(Field field, boolean autoGenerated, boolean immutableEntity) {
	 ...
	 *
	 * @param autoGenerated
	 *            whether or not the identifier is to be generated
	 *            automatically.
	 */
	 ...
	 * 
	 * @return the idClassMetadata the metadata of the ID class, if any. Returns
	 *         <code>null</code>, if the Entity has a simple ID (long, Long or
	 *         String).
	 */
