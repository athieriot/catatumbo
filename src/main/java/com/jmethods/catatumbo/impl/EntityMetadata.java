...
public class EntityMetadata extends MetadataBase {
  ...
  /**
   * Property overrides for embedded fields of the entity. The key is the override name that
   * uniquely identifies a primitive property in the entity tree.
   */
  private Map<String, Property> propertyOverrideMap;

  /**
   * Master list of properties, used for detecting duplicate property names. Key is the mapped name
   * (or property name in the datastore) and value is the qualified name of the field to report in
   * the exception.
   */
  ...
  /**
   * Validates this metadata to ensure there are no duplicate property names defined in this
   * entity/embedded objects.
   */
