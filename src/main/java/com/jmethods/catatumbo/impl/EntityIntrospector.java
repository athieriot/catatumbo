...
public class EntityIntrospector {
	...
	private void processIdentifierField(Field field) {
		...
		IdentifierMetadata identifierMetadata = new IdentifierMetadata(field, autoGenerated, entityMetadata.isImmutable());
	...
	private void processKeyField(Field field) {
		...
		KeyMetadata keyMetadata = new KeyMetadata(field, entityMetadata.isImmutable());
	...
	private void processParentKeyField(Field field) {
		...
		ParentKeyMetadata parentKeyMetadata = new ParentKeyMetadata(field, entityMetadata.isImmutable());
