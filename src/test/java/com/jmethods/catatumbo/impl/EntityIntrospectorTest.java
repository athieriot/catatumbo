...
public class EntityIntrospectorTest {
  ...
  public void testIntrospect_OptimisticLock1() {
    ...
    assertTrue(
        Objects.equals(metadata.getVersionMetadata(), metadata.getPropertyMetadata("version")));
  }
  ...
  public void testIntrospect_MultiThreaded() {
    ...
    Class<?>[] entityClasses = { StringId.class, StringField.class, StringId.class,
        StringField.class };
  ...
  public void testIntrospect_Embedded_Imploded() {
    ...
    Map<EmbeddedField, EmbeddedMetadata> embeddedMetadataMap = entityMetadata
        .getEmbeddedMetadataMap();
